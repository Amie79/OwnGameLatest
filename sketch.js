...
function draw() {
  ...
  if(frameCount%100==0){
    skeleton3.x=Math.round(random(940,500))
  }
  pirate.velocityX=0;
  pirate.velocityY=0;
  createEdgeSprites();
  ...
  if(pirate.isTouching(treasurebox1)){
    score=score+10;

  }

  if(pirate.isTouching(treasurebox2)){
    score=score+10;
    
  }

  if(pirate.isTouching(treasurebox3)){
    score=score+10;
    
  }

  if(pirate.isTouching(treasurebox4)){
    score=score+10;
